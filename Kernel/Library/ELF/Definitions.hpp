...
namespace ELF
{
    ...
    inline constexpr bool operator&(const SegmentAttributes& lhs,
                                    SegmentAttributes        rhs)
    {
    ...
    enum class DynamicEntryType : i64
    {
        ...
        ePltGot                  = 3,  // DT_PLTGOT
        eHash                    = 4,  // DT_HASH
        eStringTable             = 5,  // DT_STRTAB
        eSymbolTable             = 6,  // DT_SYMTAB
        eRela                    = 7,  // DT_RELA
        eRelaSize                = 8,  // DT_RELASZ
        eRelaEnt                 = 9,  // DT_RELAENT
        eStringTableSize         = 10, // DT_STRSZ
        eSymbolSize              = 11, // DT_SYMENT
        eInit                    = 12, // DT_INIT
        eFini                    = 13, // DT_FINI
        ...
        eSymbolTableSectionIndex = 34, // DT_SYMTAB_SHNDX
        eRelr                    = 35, // DT_RELR
