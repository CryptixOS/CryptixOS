...
constexpr usize O_CREAT     = 0100;
constexpr usize O_EXCL      = 0200;
constexpr usize O_NOCTTY    = 0400;
constexpr usize O_TRUNC     = 1000;
constexpr usize O_APPEND    = 2000;
constexpr usize O_NONBLOCK  = 4000;
