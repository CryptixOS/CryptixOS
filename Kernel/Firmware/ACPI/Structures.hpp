...
namespace ACPI
{
    ...
    enum class IA32BootArchitectureFlags : u16
    {
        eLegacyDevices       = Bit(0),
        e8042                = Bit(1),
        eVGA_NotPresent      = Bit(2),
        eMSI_NotSupported    = Bit(3),
        ePCIeASPM_Controls   = Bit(4),
        eCMOS_RTC_NotPresent = Bit(5),
    };
    inline bool operator&(IA32BootArchitectureFlags lhs,
                          IA32BootArchitectureFlags rhs)
    {
    ...
    struct [[gnu::packed]] FADT
    {
        ...
        IA32BootArchitectureFlags IA32BootArchitectureFlags;
