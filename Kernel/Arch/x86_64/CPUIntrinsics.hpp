...
#define Asm(...) __asm__ volatile(__VA_ARGS__)
    ...
    CTOS_ALWAYS_INLINE void cpuid(u64 leaf, u64 subleaf, u64& rax,
    ...
    CTOS_ALWAYS_INLINE bool InterruptsEnabled()
    {
        return Flags() & Bit(9);
    }
    ...
    CTOS_ALWAYS_INLINE void EnableUserAccess() { Asm("stac"); }
    CTOS_ALWAYS_INLINE void DisableUserAccess() { Asm("clac"); }
